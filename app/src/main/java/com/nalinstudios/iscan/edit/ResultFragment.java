...
public class ResultFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.result_layout2, null);
        init();
        return view;
    }
    ...
    private void init() {
        ...
        cropButton = view.findViewById(R.id.crop);
        cropButton.setOnClickListener(new CropButtonListener());
        getBitmap();
    }
    ...
    private class DeleteButtonListener implements View.OnClickListener{
        ...
        private void delete(){
            ...
            ((PDFEditActivity)getActivity()).delete(ResultFragment.this);
    ...
    /**
     * A class to crop the image
     */
    private class CropButtonListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            ((PDFEditActivity)getActivity()).startScan(ResultFragment.this);
        }
    }
