/**
 * A package for storing all other helper classes used by our Activities.
 * This package contains classes which are used to perform functions like generating cardViews for each PDF, Handle zoom gestures, create PDFs, etc.
