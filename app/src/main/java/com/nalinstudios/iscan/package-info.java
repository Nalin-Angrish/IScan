/**
 * The base package for the application. This package contains the Activities that constitute this application.
 * The Classes in this package are:<ol>
 *      <li>MainActivity : It will make the main list of all the PDFs created till now and will provide access to the other activities.</li>
